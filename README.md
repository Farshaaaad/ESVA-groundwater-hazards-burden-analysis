...
Use the citation generated by GitHub from `CITATION.cff`. After Zenodo assigns a DOI, cite the archived software release rather than only the moving GitHub branch.
